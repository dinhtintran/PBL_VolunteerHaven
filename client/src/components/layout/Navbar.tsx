...
//       <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-100">
...
//                 <Button variant="outline" size="sm">{t("nav.editProfile")}</Button>
//                 </Link> */}
...
//       {/* Mobile menu */}
//       {isMenuOpen && (
//         <div className="sm:hidden pt-100">
...
//                   </Link>
//                   <Link href="/edit-profile">
//                   <Button className="w-full" variant="default">{t("nav.editProfile")}</Button>
//                 </Link>
...
export function Navbar() {
  ...
  return (
    <nav className="bg-white shadow-sm fixed top-0 w-full z-30">
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            ...
            <div className="hidden sm:ml-6 sm:flex sm:space-x-8 ml-6">
              {["/", "/campaigns", "/about", "/contact"].map((path) => (
                <Link
                  key={path}
                  href={path}
                  className={`${
      ...
      {/* Mobile menu */}
      {isMenuOpen && (
        <div className="sm:hidden bg-white shadow-md border-t pt-2">
          ...
          <div className="px-4 pt-4 pb-4 border-t">
            {user ? (
              <div className="flex flex-col space-y-2">
                ...
                <Link href="/edit-profile">
                  <Button className="w-full">{t("nav.editProfile")}</Button>
                </Link>
                {user.userType === "admin" && (
                  <Link href="/admin">
                    <Button className="w-full">{t("nav.admin")}</Button>
                  </Link>
                )}
                <Button className="w-full" variant="outline" onClick={handleLogout}>
                  {t("nav.logout")}
